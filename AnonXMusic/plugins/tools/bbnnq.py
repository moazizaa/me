...
@app.on_message(command("لولو") & filters.group)
async def bottttt(client, message):
    selections = [f"عمرها لولو 🤍🧚🏼‍♂️ {message.from_user.mention}", 
f"يا قلب لولو ♥ {message.from_user.mention}",
f"صرعت راسها لولو 🙈 {message.from_user.mention}",
